...
//{
//    private ConcurrentDictionary<string, TradeOffer> BotTradeCache { get; init; }

//    private BotDeliverStatus BotDeliverStatus { get; init; }
...
//    public BuffHandler(Bot bot)
//    {
//        BotTradeCache = new ConcurrentDictionary<string, TradeOffer>();
//        BotDeliverStatus = new BotDeliverStatus();
//        Bot = bot;
//    }

//    internal async void OnBuffTimer(object? _ = null)
//    {
...
//    /// <returns></returns>
//    internal async Task<bool> CheckDeliver(Bot bot)
//    {
...
//    internal void AddTradeCache(Bot bot, TradeOffer tradeOffer)
//    {
...
//    /// </summary>
//    /// <param name="bot"></param>
//    internal void InitTradeCache(Bot bot)
//    {
